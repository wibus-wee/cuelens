...
This directory ships inside `@wibus/cuelens` so a developer or coding agent can
understand the dependency without opening the repository website.
...
| 3     | [`architecture/cuelens.md`](architecture/cuelens.md) | Runtime boundaries, data flow, camera design, and the proposed visual Creator architecture.                            |
